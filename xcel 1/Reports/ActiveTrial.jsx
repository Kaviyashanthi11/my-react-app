...
const InactiveCustomers = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        "/React/web/index.php?r=report/active-trial-customers"
      );
  ...
  const handleExportToExcel = () => {
    ...
    const ws = XLSX.utils.aoa_to_sheet([
      ["Active Trial Customer Reports"], // Title row
    ...
    ws["A1"] = {
      v: "Active Trial Customer Report",
      t: "s",
      s: {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Acticve Trial Customers");

    // Save file
    XLSX.writeFile(wb, "Active Trial Customers.xlsx", {
      bookType: "xlsx",
      bookSST: false,
      type: "binary",
      cellStyles: true
