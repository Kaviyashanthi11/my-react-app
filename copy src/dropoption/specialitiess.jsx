export const Submission = [
  { value: "1", label: "API" },
  { value: "2", label: "Bulk Upload" },
  { value: "3", label: "Bulk Entry" },
  { value: "4", label: "Real Time" },
];
...
const speciality = [
  ...
  { value: "72", label: " I nhalation Therapy" },
  ...
  { value: "B2", label: " Brand Name Prescription Drug - Formulary" },
  {
    value: "B3",
    label:
      " Brand Name Prescription Drug - Non-Formulary BA Independent Medical Evaluation",
  },
