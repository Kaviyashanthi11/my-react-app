...
const Transaction = () => {
  ...
  const handleExportToExcel = async () => {
    const headerStyle = {
      ...
      fill: { type: "pattern", pattern: "solid", fgColor: { argb: "C2E0F9" } }, // Light blue background
    ...
    const worksheet = workbook.addWorksheet("Transaction Reports-"+ (formData.transactiontype === '1' || formData.transactiontype === '4')
...
// Define column-specific alignments
...
titleCell.fill = {
  type: 'pattern',
  pattern: 'solid',
  fgColor: { argb: 'C2E0F9' }, // Light blue background
};
    const reportInfo = [
...
const columnAlignments = {
  "SNO": { horizontal: "center", vertical: "middle" },
  "Payer": { horizontal: "left", vertical: "middle" },
  "Policy ID": { horizontal: "left", vertical: "middle" },
  "Status": { horizontal: "left", vertical: "middle" },
  "# of Response Received": { horizontal: "left", vertical: "middle" },
  "Patient Name": { horizontal: "left", vertical: "middle" },
  "Patient Gender": { horizontal: "center", vertical: "middle" },
  "Patient DOB": { horizontal: "center", vertical: "middle" },
  "Date Of Service": { horizontal: "center", vertical: "middle" },
  "Address": { horizontal: "left", vertical: "middle" },
  "Response Date": { horizontal: "center", vertical: "middle" },
};
...
dataToExport.forEach((row, rowIndex) => {
  ...
  Object.entries(row).forEach(([key, value], colIndex) => {
    ...
    // Determine and apply alignment based on column header
    const alignment = columnAlignments[key] || { horizontal: "center", vertical: "middle" }; // Default alignment
    cell.alignment = alignment;

    // Apply other styles to the cell
